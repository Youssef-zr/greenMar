...
<div>
      ...
      <div
        ...
        style="background: url(images/background/Banner.jpg) no-repeat left; background-size:cover"
      >
        <div class="container">
          <div class="box">
    ...
    <section class="default-section sec-padd mobile-center">
        <div class="container">
            ...
            <div class="col-lg-10 col-lg-offset-1 col-md-8 col-sm-12">
                ...
                <h4 class="bg-green text-center mobile-font" style="margin-bottom: 40px;">
                ...
                <div class="row mb-30">
                    ...
                    <div class="img-box mb-20">
                        <img src="images/recyling/1.jpg" alt="" class="img-responsive mb-20 w-100"/>
                    </div>
                    </div>
                ...
                <div class="row mb-30">
                    <div class="col-md-5 col-sm-5 col-xs-12">
                    <div class="img-box mb-20">
                        <img src="images/recyling/2.jpg" alt="" class="img-responsive mb-20 w-100"/>
                    </div>
                    </div>
                    <div class="col-md-7 col-sm-7 col-xs-12 mb-20">
                    <h4 class="text-green mb-10  mobile-font-18">DECHETS DANGEREUX</h4>
                    <div class="text">
                        <p class="text-dark">
                ...
                <div class="row mb-30">
                    <div class="col-md-5 col-sm-5 col-xs-12">
                    <div class="img-box">
                        <img src="images/recyling/3.jpg" alt="" class="img-responsive mb-20 w-100"/>
                    </div>
                    </div>
                    <div class="col-md-7 col-sm-7 col-xs-12">
                    <h4 class="text-green mb-10">DÉCHETS BANALS</h4>
                    <div class="text">
                        <p class="text-dark">
                ...
                <div class="plus service mb-50">
                    ...
                    <div class="col-sm-4 mb-sm-80">
                        <img src="images/recyling/4.jpg" alt="" class="img-responsive mb-20 w-100"/>
                    </div>
                    <div class="col-sm-8">
